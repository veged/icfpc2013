...
###### 4. _What steps did you take to limit the search space of programs? For example, how did you exploit the following features:_
...
More close to the contest end, for higher-sized programs we had choosen another strategy:
  1. For a given set of operators generate a maximum set of programs of all sizes (from small to large) that our resources (memory and CPU) allow. This was about 100-200M of programs.
...
###### 5. _What steps did you take to parallelize the search?_
_How much parallelism did you manage to achieve?_
_For example, how many threads/processes did you have going in parallel?_
_How did you manage the concurrency? Language support, libraries, OS-level process support?_
...
###### 6. _Did you use different strategies for each class of problem?_
_The classes of problems were:_
...
###### 7. _How did you cope with the following elements of the game:_
  ...
  - _How did you deal with the element of risk in the game? For example, many of the large fold-free problems could in fact be solved with a small guess._
...
###### 10. _What kind of bugs did you run into when developing your solution? How did you discover and fix those bugs?_
...
###### 11. _What hardware did you use? e.g., laptop, university servers, cloud etc._
...
Several single processor workstations:
  ...
  - Intel Core i5 (2.5GHz), 8GB memory
